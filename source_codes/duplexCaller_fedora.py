...
'''
            ...
            THIS VERSION WORKS FOR FEDORA SYSTEMS; TRYING TO FIX THE ISSUE IN LINE 239

BEGIN COPYRIGHT NOTICE

     duplexCaller_fedora code -- (c) 2017 Dimitrios Kleftogiannis -- ICR -- www.icr.ac.uk
...
RUNNING
    ...
    python duplexCaller_fedora.py bamFile=Example_chr17.bam positionFile=example_positions.bed referenceGenome=myRef.fa
...
def printUsage():
    ...
    print('\tpython duplexCaller_fedora.py bamFile=file.bam positionFile=file.txt referenceGenome=file.fa\n')
    print('Where:\n') 
    ...
    print('\tpython duplexCaller_fedora.py bamFile=Example_chr17.bam positionFile=example_positions.txt referenceGenome=myRef.fa \n')
...
#first check if the bam file exists
    ...
    if os.path.exists(bamFile):
        ...
        for key in posList:
            ...
            #THIS PART WORKS ONLY FOR FEDORA
            #if you use MAC, this code is not gonna work, so contact Dimitrios
...
def myMain():
    ...
    if len(sys.argv)!=4:
        ...
        print('************************************************************************************************************************************\n')
        print('\t\t\tduplexCaller: Identification of variants supported by duplex read family pairs (Fedora version)\n')
        print('\t\t\t\t\tCEC Bioinformatics & CEC Translational Oncogenomics Team\n')
        print('\t\t\tCopyright 2017 ICR -- Dimitrios Kleftogiannis -- dimitrios.kleftogiannis@icr.ac.uk\n')
